...
```{r CMD_plot, echo = T, message=F, dev = 'tikz', fig.process=pdf2png, fig.align='center', fig.cap = 'CMD of DOLPHOT sources.'}
...
```{r CMD_plot_2, echo = T, message = F, dev = 'tikz', fig.process=pdf2png, fig.align='center',}
...
```{r, dev = 'tikz', fig.process=pdf2png, fig.align='center', fig.cap = 'Probability a source is a GC for DOLPHOT sources.'}
