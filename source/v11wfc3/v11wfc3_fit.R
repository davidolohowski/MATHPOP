...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/v11wfc3_pGC.csv')
...
# 23min - 50k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v11wfc3/res_prob_v11wfc3_seed_', seed[sim_id], '.RDS'))
