...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V14WFC3_pGC_Jans.csv')
...
cf_error <- list(alpha = 6.3, m50 = 26.5, beta0 = 0.07477, beta1 = 0.75094, m1 = 25.5)
...
# 31min - 50k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v14wfc3/res_prob_v14wfc3_Jans_seed_', seed[sim_id], '.RDS'))
