...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V7ACS_pGC_Jans.csv')
...
prior <- list(b0 = c(log(0.035), 0.4), 
              ...
              R_eff = data.frame(a = c(log(2), log(2.36)), b = rep(0.5, 2)),
...
cf_error <- list(alpha = 6.2, m50 = 26.8, beta0 = 0.07477, beta1 = 0.75094, m1 = 25.5)
...
Theta <- list(b0 = runif(1, 0.025, 0.045), 
              ...
              mu = matrix(rnorm(3, 26.2, .5), nrow = 1), 
...
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v7acs/res_prob_v7acs_Jans_seed_', seed[sim_id], '.RDS'))
