...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V9WFC3_pGC_Jans.csv')
...
c <- matrix(62*c(1893, 3255)/4400, nrow=1)
e <- c(0.89)
theta <- c(0)
UDG_ID <- c('R23')
...
prior <- list(b0 = c(log(0.015), 0.4), 
                 ...
                 R_eff = data.frame(a = rep(log(2.85), 1), b = 0.5),
...
cf_error <- list(alpha = 6.9, m50 = 26.5, beta0 = 0.07477, beta1 = 0.75094, m1 = 25.5)
...
# 15min - 50k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v9wfc3/res_prob_v9wfc3_Jans_seed_', seed[sim_id], '.RDS'))
