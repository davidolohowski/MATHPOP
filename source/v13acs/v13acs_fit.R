...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/v13acs_pGC.csv')
...
# 32min - 50k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v13acs/res_prob_v13acs_seed_', seed[sim_id], '.RDS'))
