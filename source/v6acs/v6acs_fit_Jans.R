...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V6ACS_pGC_Jans.csv')
...
cf_error <- list(alpha = 7.2, m50 = 26.7, beta0 = 0.07477, beta1 = 0.75094, m1 = 25.5)
...
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v6acs/res_prob_v6acs_Jans_seed_', seed[sim_id], '.RDS'))
