...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V13WFC3_pGC_Jans.csv')
...
cf_error <- list(alpha = 6, m50 = 26.6, beta0 = 0.07477, beta1 = 0.75094, m1 = 25.5)
...
set.seed(seed[sim_id])
res_prob <- fit_mod_np(S, grid, Theta, UDG_ID, c, e, theta, Y_obs, p = 1, prior, M = 50000, tune, cf_error = cf_error)

# 31min - 50k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v13wfc3/res_prob_v13wfc3_Jans_seed_', seed[sim_id], '.RDS'))
