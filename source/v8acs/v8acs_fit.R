...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/v8acs_pGC.csv')
...
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v8acs/res_prob_v8acs_seed_', seed[sim_id], '.RDS'))
