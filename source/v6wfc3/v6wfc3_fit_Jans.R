...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V6WFC3_pGC_Jans.csv')
...
cf_error <- list(alpha = 6.6, m50 = 26.5, beta0 = 0.07477, beta1 = 0.75094, m1 = 25.5)
...
# 32min - 50k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v6wfc3/res_prob_v6wfc3_Jans_seed_', seed[sim_id], '.RDS'))
