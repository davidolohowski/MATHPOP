...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V9ACS_pGC_Jans.csv')
...
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v9acs/res_prob_v9acs_Jans_seed_', seed[sim_id], '.RDS'))
