...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V14ACS_pGC_Jans.csv')
...
cf_error <- list(alpha = 6.6, m50 = 26.7, beta0 = 0.07477, beta1 = 0.75094, m1 = 25.5)
...
# 50min - 50k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v14acs/res_prob_v14acs_Jans_seed_', seed[sim_id], '.RDS'))
