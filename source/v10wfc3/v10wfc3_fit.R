...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/v10wfc3_pGC.csv')
...
# 33min - 50k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v10wfc3/res_prob_v10wfc3_seed_', seed[sim_id], '.RDS'))
