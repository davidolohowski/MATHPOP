...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V10WFC3_pGC_Jans.csv')
...
e <- c(0.88, 1.35, 0.75)
theta <- c(0, -pi/12, 0)
UDG_ID <- c('R27', 'W84', 'W83')

prior <- list(b0 = c(log(0.035), 0.4), 
                 N = data.frame(a = rep(0, 3), b = rep(50, 3)), 
                 R_eff = data.frame(a = c(log(2.23), log(0.81), log(1)), b = rep(0.5, 3)),
...
cf_error <- list(alpha = 6.4, m50 = 26.6, beta0 = 0.07477, beta1 = 0.75094, m1 = 25.5)
...
# 33min - 50k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v10wfc3/res_prob_v10wfc3_Jans_seed_', seed[sim_id], '.RDS'))
