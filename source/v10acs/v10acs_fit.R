...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/v10acs_pGC.csv')
...
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v10acs/res_prob_v10acs_seed_', seed[sim_id], '.RDS'))
