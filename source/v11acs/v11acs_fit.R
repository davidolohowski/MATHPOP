...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/v11acs_pGC.csv')
...
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v11acs/res_prob_v11acs_seed_', seed[sim_id], '.RDS'))
