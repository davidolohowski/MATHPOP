...
Y_obs <- read_csv('/project/6055726/dli346/GC_count_PP/data/prob_GC_data/V15WFC3_pGC_Jans.csv')
...
cf_error <- list(alpha = 7, m50 = 26.5, beta0 = 0.07477, beta1 = 0.75094, m1 = 25.5)
...
# 31min - 100k
saveRDS(res_prob, paste0('/project/6055726/dli346/GC_count_PP/data/v15wfc3/res_prob_v15wfc3_Jans_seed_', seed[sim_id], '.RDS'))
